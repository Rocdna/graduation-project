...
import { fetchAddDriver, fetchUpdateDriver } from '@/service/api';
...
<template>
  <ElDrawer v-model="visible" :title="title" :size="360">
    <ElForm ref="formRef" :model="model" :rules="rules" label-position="top">
      ...
      <ElFormItem :label="$t('page.manage.user.licensePlate')" prop="licensePlate">
        <ElInput v-model="model.profile.licensePlate" :placeholder="$t('page.manage.user.licensePlate')" />
      </ElFormItem>
      <ElFormItem :label="$t('page.manage.user.vehicleModel')" prop="vehicleModel">
        <ElInput v-model="model.profile.vehicleModel" :placeholder="$t('page.manage.user.vehicleModel')" />
      </ElFormItem>

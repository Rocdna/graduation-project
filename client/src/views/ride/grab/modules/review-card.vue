...
const createOverlay = () => {
  ...
  overlay.className = 'fixed inset-0 w-full h-full bg-black/40 z-[1001]';
...
<template>
  ...
  <div
    ...
    v-show="localVisible"
    ref="cardRef"
    class="review-card fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-2xl p-6 z-[1002]"
  >
